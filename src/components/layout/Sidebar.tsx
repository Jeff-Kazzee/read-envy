...
export function Sidebar({ currentView, onViewChange }: SidebarProps) {
  return (
    <aside className="w-(--sidebar-width) border-r border-(--void-border) bg-(--void-surface) flex flex-col">
              ...
              <button
                ...
                className={cn(
                  ...
                  currentView === item.id
                    ...
                    : 'text-(--void-text-muted) hover:bg-(--void-surface-hover) hover:text-(--void-text)'
                )}
              >
                {item.icon}
                {item.label}
      ...
      <div className="p-4 border-t border-(--void-border)">
        <p className="text-xs text-(--void-text-dim) text-center">
          Read-Envy v0.1.0
        </p>
      </div>
    </aside>
